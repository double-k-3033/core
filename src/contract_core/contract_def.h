...
#define QFOMO_CONTRACT_INDEX 27
#define CONTRACT_INDEX QFOMO_CONTRACT_INDEX
#define CONTRACT_STATE_TYPE QFOMO
#define CONTRACT_STATE2_TYPE QFOMO2
#include "contracts/QFomo.h"
...
constexpr struct ContractDescription
{
    ...
    {"QFOMO", 215, 10000, sizeof(QFOMO::StateData)}, // proposal in epoch 213, IPO in 214, construction and first use in 210
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
...
static void initializeContracts()
{
    ...
    REGISTER_CONTRACT_FUNCTIONS_AND_PROCEDURES(QFOMO);
    // new contracts should be added above this line
#ifdef INCLUDE_CONTRACT_TEST_EXAMPLES
